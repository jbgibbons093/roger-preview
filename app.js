...
import { freshDefinition, readDefinition, validateDefinition, connectionIssues, requiredTables, compileSas, parseCodes, TABLES as RAW_TABLES, DOMAINS as RAW_DOMAINS } from './cohort.js?v=6a6eb270afc6';
import { openCodePicker } from './code-picker.js?v=6a6eb270afc6';
import { treeFor, groupsIn, logicText, usesOr, removeCriterion } from './logic.js?v=6a6eb270afc6';
import { renderTree, bindTree } from './cohort-tree.js?v=6a6eb270afc6';
import { selectionProtocol } from './protocol.js?v=6a6eb270afc6';
...
try {
  ...
  const responses=await Promise.all([fetch('./catalog.json?v=6a6eb270afc6'),fetch('./cohort_engine.sas?v=6a6eb270afc6'),fetch('./cdm_engine.sas?v=6a6eb270afc6')]);
