...
import { freshDefinition, readDefinition, validateDefinition, connectionIssues, requiredTables, compileSas, parseCodes, TABLES as RAW_TABLES, DOMAINS as RAW_DOMAINS } from './cohort.js?v=2164d6d6b6fc';
import { openCodePicker } from './code-picker.js?v=2164d6d6b6fc';
import { treeFor, groupsIn, logicText, usesOr, removeCriterion } from './logic.js?v=2164d6d6b6fc';
import { renderTree, bindTree } from './cohort-tree.js?v=2164d6d6b6fc';
import { selectionProtocol } from './protocol.js?v=2164d6d6b6fc';
import { parseCsv, previewRows, quickCounts, missingness, compileQuickCount } from './results.js?v=2164d6d6b6fc';
...
try {
  ...
  const responses=await Promise.all([fetch('./catalog.json?v=2164d6d6b6fc'),fetch('./cohort_engine.sas?v=2164d6d6b6fc'),fetch('./cdm_engine.sas?v=2164d6d6b6fc')]);
